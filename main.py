...
<code>/scr https://t.me/+aGWRGz 50</code>
      ...
      if results == 'None':
        ...
        if chat_type == "ChatType.PRIVATE" and status == "FREE":
          resp = "𝗢𝗡𝗟𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗔𝗥𝗘 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 𝗧𝗢 𝗨𝗦𝗘 𝗕𝗢𝗧 𝗜𝗡 𝗣𝗘𝗥𝗦𝗢𝗡𝗔𝗟 ⚠️.𝗬𝗢𝗨 𝗖𝗔𝗡 𝗨𝗦𝗘 𝗙𝗥𝗘𝗘𝗟𝗬 𝗕𝗢𝗧 𝗛𝗘𝗥𝗘@Devil_O4"
          await message.reply_text(resp, message.id)

        elif chat_id not in GROUP:
          resp = "𝗨𝗡𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘𝗗 𝗖𝗛𝗔𝗧 ❌. 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 @Devil_O4 𝗧𝗢 𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘."
          await message.reply_text(resp, message.id)
        else:
          #CREDIT CHECK
                ...
                try:
                  ...
                  async for msg in user.get_chat_history(channel_id, limit):
                    ...
                    for item in cards:
                      ...
                      file_name = f"{limit}x_CC_Scraped_By_@CcfilesKillbot.txt"
...
● 𝗕𝗼𝘁 𝗕𝘆: <a href="tg://user?id=1818448444">ᴅᴇᴠɪʟ~ᴏᴘ™</a>
"""
                  document = file_name
